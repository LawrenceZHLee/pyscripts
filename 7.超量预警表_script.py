...
f = open('7.超量预警表数据_data_10000.csv', 'w',encoding='UTF-8')
r = 0
prealarm_id = 70000000000000000000000000000000
...
while r <= 10001:
    ...
    f.writelines('\n'+'"'+str(prealarm_id)+'","'+ent+'","'+stockname+'","'+prealarmtimestr+'","'+str(cleanupusetimeint)+'小时","超量'+str(prealarmmount)+'箱"')
    f.flush()
f.close()
