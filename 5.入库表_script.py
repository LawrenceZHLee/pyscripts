...
f = open('5.入库表数据_data_20000.csv', 'w',encoding='UTF-8')
r = 0
in_id = 50000000000000000000000000000000
...
while r <= 20001:
    ...
    indate = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(random.randint(start, end)))
    inmount = random.randint(50, 100)

    print(stockname)
    f.writelines('\n'+'"'+str(in_id)+'","'+ent+'","'+stockname+'","'+indate+'","'+str(inmount)+'"')
    f.flush()
f.close()
